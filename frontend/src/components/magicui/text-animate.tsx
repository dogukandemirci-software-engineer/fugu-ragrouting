// Adapted from MagicUI (https://magicui.design/docs/components/text-animate), MIT licensed.
import { memo } from 'react';
import { AnimatePresence, motion, Variants, type MotionProps } from 'framer-motion';
...
const TextAnimateBase = ({
  ...
  const MotionComponent = motionElements[Component] as typeof motion.p;
