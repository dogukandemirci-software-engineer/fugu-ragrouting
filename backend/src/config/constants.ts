...
export const PLAN_CATALOG = [
  {
    ...
    storageLabel: '5 MB',
    features: ['20 queries/month', 'Vector routing', '5 MB total document storage'],
  },
  {
    ...
    period: 'month',
    queries: '1,000',
    monthlyQueryLimit: 1_000,
    storageLabel: '300 MB',
    features: ['1,000 queries/month', 'Vector + Graph routing', '300 MB total document storage', 'Webhooks', 'Priority support'],
    highlighted: true,
  },
  {
    ...
    period: 'year',
    queries: '20,000',
    monthlyQueryLimit: 20_000,
    storageLabel: '10 GB',
    features: ['20,000 queries/month', 'All Pro features', '10 GB total document storage', 'SSO/SAML (coming soon)', 'SLA', 'Dedicated support'],
    contactUs: true,
  },
] as const;
